...
(function($) {
    ...
    function Plugin($container, options) {
        ...
        function _setEvents() {
            ...
            if(hasCanvas) {
                /*
                 * We are using bootstrap dropdown menu
                 * so we don't need to handle any toggle
        ...
        this.setColor = function(color) {
			 ...
			 *     because our element 
			 *     is not a div but a svg  - Pawan Bishnoi
			 * - - - - - - - - - - - - - - - */
            $color.find("svg").css({ 'fill': self.colorHex });
        ...
        this.close = function() {
            ...
            //$track.hide(); no need it will automatically get hidden  - Pawan Bishnoi
        };
