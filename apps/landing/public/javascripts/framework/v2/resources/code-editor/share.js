  ...
  */
  ...
  Connection = (function() {
    function Connection(host, authentication) {
      ...
      Connection.prototype.onmessage = function(event, msg) {
        var docName;
		var _this = this;
    ...
    Connection.prototype.open = function(docName, type, callback) {
      ...
      if (this.state === 'connecting') {
	    ...
	    this.send ({ auth : null, docName: docName });
  ...
  exports.open = (function() {
    ...
    return function(docName, type, options, callback) {
	  ...
	  if (c.state && c.state !== "ok" && c.state !== "handshaking") {
		  __event.bind("editor:connection", c.onmessage.bind(c), "message");
	  }
